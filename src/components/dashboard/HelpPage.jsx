    ...
    <div className="space-y-6 max-w-4xl select-none duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="p-4 border border-slate-100 bg-white shadow-sm space-y-2">
          ...
          <h3 className="font-extrabold text-sm text-slate-900">Instant SGPA & CGPA</h3>
          <p className="text-xs text-slate-500 font-semibold leading-relaxed">
      ...
      <Card className="p-6 border border-slate-100 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-semibold">Click any question to view answers</p>
          </div>
        </div>
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                {isOpen && (
                  <div className="px-4 pb-4 text-xs font-semibold text-slate-600 whitespace-pre-line leading-relaxed border-t border-slate-100 pt-3 bg-white">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <Card className="p-6 border border-slate-100 shadow-sm space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-extrabold text-slate-900">Grade Point Reference Scale</h3>
              <p className="text-xs text-slate-400 font-semibold">SKCET Regulation 2022 Grading System</p>
            </div>
          </div>
          ...
          <table className="w-full text-left border-collapse text-xs font-semibold">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-2.5 px-3 text-center font-black text-slate-900">7.0</td>
                <td className="py-2.5 px-3 text-center text-slate-600">61 – 70%</td>
                <td className="py-2.5 px-3 text-right font-bold text-slate-700">Good</td>
              </tr>
              <tr className="hover:bg-slate-50">
                <td className="py-2.5 px-3 font-black text-orange-600">B</td>
                <td className="py-2.5 px-3 text-center font-black text-slate-900">6.0</td>
                <td className="py-2.5 px-3 text-center text-slate-600">56 – 60%</td>
                <td className="py-2.5 px-3 text-right font-bold text-slate-700">Above Average</td>
              </tr>
              <tr className="hover:bg-slate-50">
                <td className="py-2.5 px-3 font-black text-slate-600">C</td>
                <td className="py-2.5 px-3 text-center font-black text-slate-900">5.0</td>
                <td className="py-2.5 px-3 text-center text-slate-600">50 – 55%</td>
                <td className="py-2.5 px-3 text-right font-bold text-slate-700">Average</td>
              </tr>
              <tr className="hover:bg-slate-50">
